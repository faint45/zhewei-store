...
export const products: Product[] = [
  {
    ...
    tagline: "秒解圖紙，結構化產出",
    description:
      "將 PDF 設計圖、規範書、施工圖自動解析為結構化資料。支援批次處理，省去人工逐頁比對的繁瑣作業。",
  ...
  },
  {
    id: "site-ai",
    name: "工地智眼 SiteAI",
    tagline: "現場拍照、語音，AI 自動建檔",
    description:
      "工地人員用手機拍照或語音回報，AI 即時辨識施工進度、品質問題，自動產生結構化紀錄並彙整日報。",
  ...
  },
  {
    id: "plan-ai",
    name: "排程成本 PlanAI",
    tagline: "CPM 排程 + 5D 成本 + 投標模擬",
    description:
      "整合排程引擎（CPM）、成本估算（5D）和 Monte Carlo 投標模擬。一次輸入專案描述，產出完整的排程、預算、風險分析和決標建議。",
  ...
  },
  {
    ...
    tagline: "拍照自動填寫安全檢查表",
    description:
      "工地安衛人員拍下現場照片，AI 自動辨識安全缺失並填寫標準檢查表。即時標記高風險項目，減少漏檢風險。",
